...
GO_VERSION="${GO_VERSION:-1.25.14}"        # keep in sync with Dockerfile's GO_VERSION and go.mod's toolchain directive; override: GO_VERSION=1.26.0 bash scripts/setup.sh
