...
GO_VERSION="${GO_VERSION:-1.26.0}"        # keep in sync with Dockerfile GO_VERSION and go.mod go directive (go_pins_test.go enforces); override: GO_VERSION=1.26.0 bash scripts/setup.sh
